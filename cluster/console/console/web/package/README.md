...
**Personal Use:** We are pleased to offer Octelium Enterprise completely free of charge, forever, for non-commercial personal use (as strictly defined within the `LICENSE` file).
