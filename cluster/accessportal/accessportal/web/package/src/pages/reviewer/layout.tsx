    ...
    <div className="min-h-screen w-full bg-slate-50">
      <header className="sticky top-0 z-20 w-full border-b border-slate-200 bg-white/80 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <Link to="/reviewer/requests" className="flex items-center gap-2">
            ...
            <span className="text-[0.6rem] font-bold uppercase tracking-[0.08em] text-slate-400 border border-slate-200 rounded px-1.5 py-0.5">
              Reviewer
            </span>
          </Link>
