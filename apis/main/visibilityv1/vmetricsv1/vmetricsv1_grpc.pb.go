...
const (
	...
	MetricsService_GetMetricsCapabilities_FullMethodName = "/octelium.api.main.visibility.metrics.v1.MetricsService/GetMetricsCapabilities"
)
...
type MetricsServiceClient interface {
	...
	GetMetricsCapabilities(ctx context.Context, in *GetMetricsCapabilitiesRequest, opts ...grpc.CallOption) (*GetMetricsCapabilitiesResponse, error)
}
...
func (c *metricsServiceClient) GetMetricsCapabilities(ctx context.Context, in *GetMetricsCapabilitiesRequest, opts ...grpc.CallOption) (*GetMetricsCapabilitiesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMetricsCapabilitiesResponse)
	err := c.cc.Invoke(ctx, MetricsService_GetMetricsCapabilities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetricsServiceServer interface {
	...
	GetMetricsCapabilities(context.Context, *GetMetricsCapabilitiesRequest) (*GetMetricsCapabilitiesResponse, error)
...
func (UnimplementedMetricsServiceServer) GetMetricsCapabilities(context.Context, *GetMetricsCapabilitiesRequest) (*GetMetricsCapabilitiesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMetricsCapabilities not implemented")
}
...
func _MetricsService_GetMetricsCapabilities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMetricsCapabilitiesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetricsServiceServer).GetMetricsCapabilities(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetricsService_GetMetricsCapabilities_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).GetMetricsCapabilities(ctx, req.(*GetMetricsCapabilitiesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MetricsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMetricsCapabilities",
			Handler:    _MetricsService_GetMetricsCapabilities_Handler,
		},
	},
