...
const (
	...
	MainService_CreateSecret_FullMethodName               = "/octelium.api.main.access.v1.MainService/CreateSecret"
	MainService_GetSecret_FullMethodName                  = "/octelium.api.main.access.v1.MainService/GetSecret"
	MainService_UpdateSecret_FullMethodName               = "/octelium.api.main.access.v1.MainService/UpdateSecret"
	MainService_DeleteSecret_FullMethodName               = "/octelium.api.main.access.v1.MainService/DeleteSecret"
	MainService_ListSecret_FullMethodName                 = "/octelium.api.main.access.v1.MainService/ListSecret"
...
type MainServiceClient interface {
	...
	// GetSecret retrieves a specific Secret. The Secret's data is never
	// returned.
	...
	// ListSecret lists Secrets. The Secrets' data is never returned.
	...
	// IntegrationIdentities are entirely managed by the Cluster and can only be
	// read.
	...
	// method that does not change the access state of the Cluster. It does,
	// however, query the Integration's provider and it therefore creates or
	// refreshes the IntegrationIdentity of a successful resolution exactly like
	// the Cluster does on its own.
